...
// 상속을 받지 못하게 제한하는 키워드 sealed
// 런 타임 시 특정 함수 호출할 경우 부모, 자식 클래스를 전체 조사해 최종적으로 사용할 함수를 찾음
// sealed처리된 클래스는 이 과정을 생략
public sealed class DialogManager
{
    ...
    private void ShowNext()
    {
        ...
        // 조회한 다이얼로그 컨트롤러를 현재의 다이얼로그 컨트롤러로 지정함
